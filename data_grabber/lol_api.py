...
def fetch_summoner_account_id(summoner_name):
...
def fetch_last_matches(account_id, number):
...
def parse_participant_id(match_dict, account_id):
...
def parse_participant_match_info(match_dict, participant_id):
...
def parse_dame_duration(match_dict):
    game_duration = match_dict['gameDuration']

    return game_duration


def parse_useful_participant_match_info(participant_match_info):
